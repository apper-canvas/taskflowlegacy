...
function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-whisper">
      <div className="w-full max-w-md space-y-8 p-8 bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100">
